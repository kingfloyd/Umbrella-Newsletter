...
function process__pdftemplate_form(){
	...
	$totalprice = floatval($pricing__newsletter_pagenum) + floatval($pdftvtpl2_printing_type) + floatval($pdftvtpl2_delivery_type) + floatval($pdftvtpl2_delivery_class) + floatval($pdftvtpl2_promotional_leaflets) + floatval($pdftvtpl2_accompanying_letter);
